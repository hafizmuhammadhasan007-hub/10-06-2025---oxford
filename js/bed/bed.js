...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function openQuickView(card) {
    ...
    const description = getBedDescription(brand, title);
    document.getElementById("modalDescription").textContent = description;
    
    // Set features
    const features = getBedFeatures(brand, title);
  ...
  document.querySelectorAll(".add-to-wishlist").forEach(btn => {
    btn.addEventListener("click", function(e) {
      e.preventDefault();
      showPopup("❤️ Bed added to wishlist!");
    });
  });
  ...
  function getBedDescription(brand, title) {
    const descriptions = {
      'ikea': 'Modern and functional bed design perfect for comfortable sleep. Easy to assemble and space-saving.',
      'ashley': 'Luxurious bed craftsmanship with premium materials for ultimate comfort and style.',
      'lazboy': 'Comfort-focused bed design with premium support system for perfect sleep experience.',
      'wayfair': 'Great value beds with comfortable designs suitable for any bedroom decor.',
      'potterybarn': 'Timeless bed designs with high-quality materials for sophisticated bedroom style.'
    };
    return descriptions[brand] || 'Comfortable, stylish and durable bed perfect for your bedroom.';
  }

  function getBedFeatures(brand, title) {
    const features = {
      'ikea': ['Modern Scandinavian design', 'Easy to assemble', 'Durable frame', 'Space-saving', 'Eco-friendly materials'],
      'ashley': ['Premium wood construction', 'Comfortable support', 'Elegant design', 'Durable build', 'Luxury finish'],
      'lazboy': ['Comfort-focused design', 'Premium mattress support', 'Durable construction', 'Stylish appeal', 'Quality craftsmanship'],
      'wayfair': ['Affordable pricing', 'Comfortable design', 'Easy assembly', 'Versatile styling', 'Great value'],
      'potterybarn': ['Handcrafted quality', 'Premium materials', 'Timeless design', 'Investment piece', 'Elegant bedroom centerpiece']
    };
    
    const brandFeatures = features[brand] || ['Durable construction', 'Comfortable support', 'Modern design', 'Easy assembly', 'Quality materials'];
