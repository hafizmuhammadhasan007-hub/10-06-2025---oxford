...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function openQuickView(card) {
    ...
    const description = getTableDescription(brand, title);
    document.getElementById("modalDescription").textContent = description;
    
    // Set features
    const features = getTableFeatures(brand, title);
  ...
  document.querySelectorAll(".add-to-wishlist").forEach(btn => {
    btn.addEventListener("click", function(e) {
      e.preventDefault();
      showPopup("❤️ Table added to wishlist!");
    });
  });
  ...
  function getTableDescription(brand, title) {
    const descriptions = {
      'ikea': 'Modern and functional design perfect for contemporary living spaces. Easy to assemble and durable.',
      'ashley': 'Luxurious craftsmanship with premium materials and elegant design. Built to last for generations.',
      'lazboy': 'Comfort-focused design with durable construction and stylish appeal. Perfect for modern homes.',
      'wayfair': 'Great value with versatile designs suitable for any home decor. Affordable quality you can trust.',
      'potterybarn': 'Timeless elegance with high-quality materials and sophisticated design. An investment in style.'
    };
    return descriptions[brand] || 'Stylish, functional and durable table perfect for your living space.';
  }

  function getTableFeatures(brand, title) {
    const features = {
      'ikea': ['Modern Scandinavian design', 'Easy to assemble', 'Durable materials', 'Space-saving', 'Eco-friendly'],
      'ashley': ['Premium wood construction', 'Elegant finish', 'Sturdy build', 'Easy maintenance', 'Luxury design'],
      'lazboy': ['Comfort-focused design', 'Premium materials', 'Durable construction', 'Stylish appeal', 'Quality craftsmanship'],
      'wayfair': ['Affordable pricing', 'Modern design', 'Easy to clean', 'Versatile styling', 'Great value'],
      'potterybarn': ['Handcrafted quality', 'Premium materials', 'Timeless design', 'Investment piece', 'Elegant finish']
    };
    
    const brandFeatures = features[brand] || ['Durable construction', 'Easy maintenance', 'Modern design', 'Functional', 'Quality materials'];
